...
Alright is a personal mental health tracking application that allows you to:
...
**Alright is NOT a medical device, diagnostic tool, or substitute for professional mental health care.**

- The App is designed for personal wellness tracking only
- AI-generated insights are for informational purposes and should not be considered medical advice
- The App does not diagnose, treat, cure, or prevent any mental health condition
- If you are experiencing a mental health crisis, please contact a mental health professional, call your local emergency services, or contact a crisis helpline immediately
- Always consult with qualified healthcare providers regarding any mental health concerns
...
- Not use the App if you are under 13 years of age

## Intellectual Property

- Alright and all associated content, features, and functionality are owned by us and protected by copyright, trademark, and other intellectual property laws
...
We reserve the right to modify these Terms at any time. We will notify you of significant changes through the App or by updating the "Last Updated" date. Your continued use of the App after changes constitutes acceptance of the new Terms.
...
*By using Alright, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.*
