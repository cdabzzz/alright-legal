...
Alright is a mental health check-in app designed with privacy as a core principle. Your emotional data stays on your device and in your personal iCloud account—we never see it.
...
### Data Processed Temporarily (Not Stored)
- **Aggregated mood summaries:** When you request AI-powered insights, we send anonymized averages (e.g., "average mood: 3.2 this week") to generate personalized insights. This data is not stored and cannot identify you.
...
- **Aggregated summaries:** To generate AI insights (processed, not stored)
...
- **AI insight requests:** Not retained; processed and discarded immediately
...
- **Opt out of AI insights:** Use the app without ever requesting AI-generated insights
...
- Your health data never leaves your device/iCloud except for anonymized AI insight requests
